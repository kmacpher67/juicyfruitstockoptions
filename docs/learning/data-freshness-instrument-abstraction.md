...
## 3. Source Precedence
- **Intraday live state (price-sensitive):** prefer TWS when connected.
- **Historical and EOD truth:** Flex remains authoritative.
- **Fallback/backfill:** yfinance and Flex are used when TWS is unavailable or for non-realtime fields.
