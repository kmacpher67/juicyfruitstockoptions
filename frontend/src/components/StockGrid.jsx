...
const StockGrid = ({ data, pageSize = 100, defaultSort = {} }) => {

    // Column Definitions: Defines the columns to be displayed.
    const [colDefs, setColDefs] = useState([
        { field: "Ticker", filter: true, sortable: true, checkboxSelection: true, pinned: 'left', maxWidth: 90 },
        ...
        // { field: "Last Update" } // Hidden as per user request
    ]);
